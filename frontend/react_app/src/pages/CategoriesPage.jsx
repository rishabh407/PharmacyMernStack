        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {categories.map((cat) => {
            ...
            return (
              <div
                key={cat.id}
                className="bg-white rounded-2xl border border-sky-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all overflow-hidden"
              >
                <div
                ...
                <div className="p-5">
                  ...
                  <button className="text-sm font-semibold text-sky-700 hover:text-sky-900 underline underline-offset-4">
                    View medicines
                  </button>
                </div>
              </div>
